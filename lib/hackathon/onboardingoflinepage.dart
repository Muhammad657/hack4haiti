...
class OnboardingOfflinePage extends StatefulWidget {
  const OnboardingOfflinePage({super.key});

  @override
  State<OnboardingOfflinePage> createState() => _OnboardingOfflinePageState();
}

class _OnboardingOfflinePageState extends State<OnboardingOfflinePage> {
  String selectedLang = "";
  @override
