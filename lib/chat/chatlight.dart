...
class CommunityChatLight extends StatefulWidget {
  const CommunityChatLight({super.key});

  @override
  State<CommunityChatLight> createState() => _CommunityChatLightState();
}

class _CommunityChatLightState extends State<CommunityChatLight> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Community Chat',
          style: GoogleFonts.lexend(color: Colors.white, letterSpacing: 2),
        ),
        toolbarHeight: 50,
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    suffixIcon: InkWell(
                      ...
                      child: Icon(Icons.send, color: Colors.blue.shade800),
                    ),
